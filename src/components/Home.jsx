    ...
    <div name="Home" className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-900'>
        <div className='max-w-screen-lg mx-auto flex flex-col md:flex-row items-center justify-center h-full px-4 sm:px-0 '>
            <div className='flex flex-col justify-center h-full sm:px-12 md:pl-12  md:w-full'>
                <h2 className='text-3xl sm:text-5xl 2xl:text-8xl font-bold text-white pt-32 md:pt-0'>
            ...
            <div className='md:w-4/6 2xl:w-full'>
                <img src={HeroImg} alt="my profile" className='rounded-3xl mx-auto w-1/2 md:w-5/6 2xl:w-full  md:flex-row' />
            </div>          
        </div>
    </div>
